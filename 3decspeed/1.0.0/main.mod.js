...
class ThreeDecimalSpeedometer extends PolyMod {
    init = (pml) => {
        ...
        pml.registerClassMixin("We.prototype", "update", MixinType.REPLACEBETWEEN, "Math.trunc(n).toString();", "Math.trunc(n).toString();", `n.toFixed(Number.parseInt(ActivePolyModLoader.getSetting("speedDecimalPlaces")));`)
    }
}
